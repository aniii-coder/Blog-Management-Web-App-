            ...
            posts.map(post  => {
              return <article key={post.id} className='postArticle'>
                ...
                <div className="dashboardActions">
                  ...
                  <Link to={`/posts/${post._id}`} className='dashboardLink'style={{textDecoration: 'none', color: 'black' }}><VisibilityIcon></VisibilityIcon></Link>
                  <Link to={`/posts/${post._id}/edit`} className='dashboardLink' style={{textDecoration: 'none', color: 'white', background:'#2778FD' }}><EditIcon></EditIcon></Link>
                  <div className="dltPost"><DeletePost postId={post._id} id='dashboardLink'></DeletePost></div>
