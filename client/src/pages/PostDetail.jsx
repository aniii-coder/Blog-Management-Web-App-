...
import Thumbnail from "../thumbnailAvatar/Misal_Pav.jpg";
      ...
      {post &&<div className="postDetailContainer">
        <div className="postDetailContainerHeader">
          ...
          {currentUser?.id == post?.creator && <div className="postDetailContainerButtons">
            <Link to={`/posts/${post?._id}/edit`} style={{backgroundColor: '#2778FD', borderRadius: '10px', display:'flex', alignItems: 'center',justifyContent:'center', color:'white', fontWeight: 'bold', textDecoration: 'none', width:'5vw'}} ><EditIcon></EditIcon></Link>
